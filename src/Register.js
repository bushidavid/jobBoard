        ...
        <div className="flex justify-center h-full w-full items-center ">  
          <div className="flex flex-col w-96 align-center rounded-md shadow-xl bg-slate-100 ">
            <p className="self-center py-1.5">Create a new account</p>
              ...
              <input type="email" id="email" name="email" className="my-1.5 mx-2" placeholder="email" value={email} onChange={(e) => setEmail(e.target.value)}/>
              <input type="password" id="" className="my-1.5 mx-2" placeholder="password" value={pass} onChange={(e) => setPass(e.target.value)}/>
            ...
            <p className="self-center py-1.5">Or Login With:</p>
